...
typedef esp_err_t (*iface_get_parameter_with_uid_fp)(void *, uint16_t, uint8_t, uint8_t *, uint8_t *);      /*!< Interface get_parameter_with_uid method */
...
typedef esp_err_t (*iface_set_parameter_with_uid_fp)(void *, uint16_t, uint8_t, uint8_t *, uint8_t *);      /*!< Interface set_parameter_with_uid method */
...
typedef struct {
    ...
    iface_get_parameter_with_uid_fp get_parameter_with_uid; /*!< Interface get_parameter_with_uid method */
    ...
    iface_set_parameter_with_uid_fp set_parameter_with_uid; /*!< Interface set_parameter_with_uid method */
